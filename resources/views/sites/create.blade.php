                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('dealer_name') ? ' has-danger' : '' }}">
                                    <label class="form-control-label"
                                           for="input-place_name">{{ __('Dealer name') }}</label>
                                    <input type="text" name="dealer_name" id="input-place-name"
                                           class="form-control{{ $errors->has('dealer_name') ? ' is-invalid' : '' }}"
                                           placeholder="{{ __('Dealer name') }}" value="{{ old('dealer_name') }}"
                                           required autofocus>

                                </div>
                                <div class="form-group{{ $errors->has('place_name') ? ' has-danger' : '' }}">
                                    <label class="form-control-label"
                                           for="input-place_name">{{ __('Place name') }}</label>
                                    <input type="text" name="place_name" id="input-place-name"
                                           class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}"
                                           placeholder="{{ __('Place name') }}" value="{{ old('place_name') }}" required
                                           autofocus>

                                </div>
                                <div class="form-group{{ $errors->has('place_id') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-place_id">{{ __('Place id') }}</label>
                                    <input type="text" name="place_id" id="input-place_id-name"
                                           class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}"
                                           placeholder="{{ __('Place id') }}" value="{{ old('place_id') }}" required
                                           autofocus>

                                </div>
                                <div class="form-group{{ $errors->has('old_website_url') ? ' has-danger' : '' }}">
                                    <label class="form-control-label"
                                           for="input-website-url">{{ __('Website') }}</label>
                                    <input type="text" name="old_website_url" id="input-website-url"
                                           class="form-control{{ $errors->has('old_website_url') ? ' is-invalid' : '' }}"
                                           placeholder="{{ __('Website url') }}" value="{{ old('old_website_url') }}"
                                           required autofocus>
                                </div>
                                <div class="form-group{{ $errors->has('lead_email') ? ' has-danger' : '' }}">
                                    <label class="form-control-label"
                                           for="input-lead-email">{{ __('Lead email') }}</label>
                                    <input type="email" name="lead_email" id="input-lead-email"
                                           class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}"
                                           placeholder="{{ __('Lead email') }}" value="{{ old('lead_email') }}"
                                           required>
                                </div>
                                ...
                                <div class="form-group{{ $errors->has('dealer_number') ? ' has-danger' : '' }}">
                                    <label class="form-control-label"
                                           for="input-dealer-number">{{ __('Dealer number') }}</label>
                                    <input type="text" name="dealer_number" id="input-dealer-number"
                                           class="form-control{{ $errors->has('dealer_number') ? ' is-invalid' : '' }}"
                                           placeholder="{{ __('Dealer number') }}" value="{{ old('dealer_number') }}"
                                           required>
                                </div>
                                ...
                                <div class="form-group{{ $errors->has('type') ? ' has-danger' : '' }}">
                                    ...
                                    <select name="type" id="input-type" data-style="btn btn-primary btn-round"
                                            class="selectpicker{{ $errors->has('type') ? ' is-invalid' : '' }}"
                                        ...
                                        @foreach( ['group','oem','independent'] as $type )
											<?php $selected = $type === old( 'type' ) ? 'selected' : ''; ?>
                                ...
                                <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                    ...
                                    <div>
                                        ...
                                        <input type="file" name="site_icon_src" class="custom-file-input"
                                ...
                                <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                    ...
                                    <div>
                                        ...
                                        <span class="fileinput-exists">{{ __('Change')}}</span>
                                        <input type="file" name="logo_src" class="custom-file-input" id="input-picture"
                                               accept="image/*"/>
                                        </span>
                                        <a href="#pablo" class="btn btn-danger btn-round fileinput-exists"
                                           data-dismiss="fileinput"><i class="fa fa-times"></i>{{__('Remove')}}</a>
