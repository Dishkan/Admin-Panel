                        ...
                        <div class="header-body text-center mb-7">
                            <div class="row justify-content-center">
                                <div class="col-lg-12 col-md-9">
                                    <h3 class="text-white">{{ __('DealerTower') }}</h3>
                                    <h4 class="text-white">
                                        {{ __('Dealer sites in seconds...') }}
                                    </h4>

                                    <p class="text-lead text-light mt-3 mb-0">
                                        {{ __('Log in and see how you can save more than 150 hours of work with DealerTower Sites Builder.') }}
